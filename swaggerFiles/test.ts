...
Returns Operations with an OR list given states. Eg. state=A,V returns operations in A or V states. Cannot use with state_not_eq.
    ...
    */
     ...
     * @method
     * @name Test#getSchemaAlertMsgType
     */
     ...
     * free text
     * @method
     * @name Test#getSchemaFreeMsgType
     */
     ...
     * @method
     * @name Test#getSchemaInformMsgType
     */
     ...
     * @method
     * @name Test#getSchemaIntentMsgType
     */
    ...
    * @method
    * @name Test#getUserUsernameUtmMsgV1
    */
